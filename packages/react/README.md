...
909 icons on one 24×24 grid, as React components. Built for shadcn/ui, free
under MIT.
...
```tsx
import { Bell } from "@ai0x0/keyline-icons"          // stroke,  909 icons
import { Bell } from "@ai0x0/keyline-icons/duotone"  // duotone, 737 icons
import { Bell } from "@ai0x0/keyline-icons/fill"     // fill,    684 icons
```
