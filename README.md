...
**721 icons, drawn on one 24×24 grid, in three weights.** Built for shadcn/ui,
...
| `duotone` | 587 | The stroke drawing over a flat plate at reduced opacity. |
| `fill` | 535 | Solid, with the detail knocked back out of the shape. |

The table is one corner treatment. Every drawing is also cut with sharp corners,
so 3,686 SVGs in total.
